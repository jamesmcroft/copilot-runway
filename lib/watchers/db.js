...
function createDbWatcher(emitter = new EventEmitter(), { debounceMs = 250, heartbeatMs = 2000 } = {}) {
  ...
  // Tail-edge debounce: fire debounceMs after the LAST event in a burst so
  // the consumer refetches once WAL writes have settled. A leading-edge
  // throttle would fire while writes are still in flight and risk consumers
