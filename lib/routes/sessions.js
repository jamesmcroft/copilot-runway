...
//
// The response keeps the legacy `turns`, `checkpoints`, `files` fields
// for backward compatibility with any client still reading them. They
// will be removed in a follow-up cleanup once the chronology renderer
